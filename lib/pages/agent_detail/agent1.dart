...
class Agent1 extends StatefulWidget {
  const Agent1({Key key}) : super(key: key);

  @override
  _Agent1State createState() => _Agent1State();
}

class _Agent1State extends State<Agent1> {
  @override
                ...
                Stack(
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset('assets/agent/agent3.png'),
                    ),
                    Positioned(
                      top: 20,
                        left: 20,
                ...
                Row(
                  children: [
                    ...
                    Expanded(child:  Column(
                      ...
                      children: const [
                        Text('Ellen Grubert',style: TextStyle(fontWeight: FontWeight.bold),)
                      ],
                    ),),
                    Expanded(child:  Row(
