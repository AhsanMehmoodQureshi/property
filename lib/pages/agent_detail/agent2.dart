...
class Agent2 extends StatefulWidget {
  const Agent2({Key key}) : super(key: key);

  @override
  _Agent2State createState() => _Agent2State();
}

class _Agent2State extends State<Agent2> {
  @override
                ...
                Stack(
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset('assets/agent/agent4.png'),
                    ),
                    Positioned(
                        top: 20,
                        left: 20,
                ...
                Row(
                  children: [
                    ...
                    Expanded(child:  Column(
                      ...
                      children: const [
                        Text('Brendan Bardic',style: TextStyle(fontWeight: FontWeight.bold),)
                      ],
                    ),),
                    Expanded(child:  Row(
