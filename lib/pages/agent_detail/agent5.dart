...
class Agent5 extends StatefulWidget {
  const Agent5({Key key}) : super(key: key);

  @override
  _Agent5State createState() => _Agent5State();
}

class _Agent5State extends State<Agent5> {
  @override
            ...
            child: Column(
              children: [
                Stack(
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset('assets/agent/agent7.png'),
                    ),
                    Positioned(
                        top: 20,
                        left: 20,
                ...
                Row(
                  children: [
                    ...
                    Expanded(child:  Column(
                      ...
                      children: const [
                        Text('California',style: TextStyle(fontWeight: FontWeight.bold),)
                      ],
                    ),),
                    Expanded(child:  Row(
                ...
                ListTile(
                  ...
                  title: const Text('california@gmail.com'),
