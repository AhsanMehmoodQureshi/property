...
class Agent3 extends StatefulWidget {
  const Agent3({Key key}) : super(key: key);

  @override
  _Agent3State createState() => _Agent3State();
}

class _Agent3State extends State<Agent3> {
  @override
                ...
                Stack(
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset('assets/agent/agent5.png'),
                    ),
                    Positioned(
                        top: 20,
                        left: 20,
                ...
                Row(
                  children: [
                    ...
                    Expanded(child:  Column(
                      ...
                      children: const [
                        Text('Phil Gutowski',style: TextStyle(fontWeight: FontWeight.bold),)
                      ],
                    ),),
                    Expanded(child:  Row(
